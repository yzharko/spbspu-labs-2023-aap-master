...
{
  rectangle = {abs(leftPoint.x-rightPoint.x), abs(leftPoint.y - rightPoint.y), {(leftPoint.x+rightPoint.x)/2, (leftPoint.y+rightPoint.y)/2}};
}
...
{
  return {abs(leftPoint.x - rightPoint.x), abs(leftPoint.y - rightPoint.y), {(leftPoint.x+rightPoint.x)/2, (leftPoint.y+rightPoint.y)/2}};
}
